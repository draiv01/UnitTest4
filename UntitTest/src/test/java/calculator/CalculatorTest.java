...
//        assertEquals(90, calculator.calculateDiscount(100.0, 10.0));
//    }
//    @Test
//    @DisplayName("Проверка расчета скидки для суммы покупки равной 0")
//    void calculateDiscount() {
//        assertEquals(0.0, calculator.calculateDiscount(0.0, 20.0));
//    }
    @Test
    @DisplayName("Проверка проверка исключения при отрицательной суммы")
    void calculateDiscount() {
        assertThatThrownBy(() -> calculator.calculateDiscount(-100.0, 150));
    }
}